...
const Sidebar = () => {
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      >
        <Image
          src="https://s3-inventorymanagement7989.s3.ap-south-1.amazonaws.com/logo.png"
          alt='vaultone-logo'
          width={27}
          height={27}
          className='rounded w-8'
        />
        <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>VAULTone</h1>
        <button
      ...
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className='text-center text-xs text-gray-500'>&copy; 2025 PriyeXH</p>
      </div>
    </div>
  )
}
